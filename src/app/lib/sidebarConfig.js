...
export const sidebarConfig = {
  ...
  recruiter: [
    ...
    {
      label: "Task Round",
      href: "/dashboard/recruiter/tasks",
      icon: CheckSquare,
    },
    {
      label: "Interviews",
    ...
    },
    {
      ...
      href: "/dashboard/recruiter/hiring",
      icon: UserCheck,
    },
    { label: "Notifications", href: "/notifications", icon: Bell },
    { label: "Settings", href: "/settings", icon: Settings },
  ...
  admin: [
    ...
    },
    {
      ...
      href: "/dashboard/admin/jobs/pending",
      icon: FileCheck,
    },
    ...
    {
      label: "Close Job Requests",
      href: "/dashboard/admin/close-requests",
      icon: XCircle,
    },
    { label: "Notifications", href: "/notifications", icon: Bell },
    {
